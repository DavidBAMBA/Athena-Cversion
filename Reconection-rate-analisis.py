...
plt.plot(times[:-1], -energy_dissipation_rate1, color='b',label='g = 0.01 \n K_v 0 10e-6 m0 = 1')
plt.plot(times[:-1], -energy_dissipation_rate2, color='r', label='g = 0.1 \n K_v 0 10e-6,  m0 = 1')
plt.plot(times[:-1], -energy_dissipation_rate3, color='g', label='g = 0.1 \n K_v 0 10e-6,  m0 = 10 ')
plt.plot(times[:-1], -energy_dissipation_rate4, label='g = 0.1 \n K_v 0 10e-6,  m0 = 10')
plt.xlabel('Time')
plt.yscale('log')
plt.xscale(1e-6,e-1)
