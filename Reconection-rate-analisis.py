...
plt.plot(times[:-1], -energy_dissipation_rate1*2, color='b',label='g = 0.01 \n K_v 0 10e-6 m0 = 1')
plt.plot(times[:-1], -energy_dissipation_rate2*2, color='r', label='g = 0.1 \n K_v 0 10e-6,  m0 = 1')
plt.plot(times[:-1], -energy_dissipation_rate3*2, color='g', label='g = 0.1 \n K_v 0 10e-6,  m0 = 10 ')
